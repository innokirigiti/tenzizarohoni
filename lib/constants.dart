...
class Constants {
  ...
  static const Color primaryColor = Color.fromRGBO(255, 143, 0, 1);
  static const Color primaryColorAccent = Color.fromRGBO(255, 183, 0, 1);
  static const double versesFontSize = 20;
